...
@section('content')
    <div class="row" style="margin-top:70px">
        <div class="col">
            <form action="/izincuti/{{ $dataizin->kode_izin }}/update" method="POST" id="frmIzin">
                @csrf
                <div class="form-group">
                    <input type="text" value="{{ $dataizin->tgl_izin_dari }}" id="tgl_izin_dari" name="tgl_izin_dari"
                        autocomplete="off" class="form-control datepicker" placeholder="Dari">
                </div>
                <div class="form-group">
                    <input type="text" value="{{ $dataizin->tgl_izin_sampai }}" id="tgl_izin_sampai"
                        name="tgl_izin_sampai" autocomplete="off" class="form-control datepicker" placeholder="Sampai">
                </div>
                <div class="form-group">
                    <input type="text" id="jml_hari" name="jml_hari" class="form-control" autocomplete="off" readonly
                ...
                <div class="form-group">
                    <input type="text" value="{{ $dataizin->keterangan }}" id="keterangan" name="keterangan"
