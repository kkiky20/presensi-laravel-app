        ...
        <div id="user-detail">
            <div class="avatar">
                @if (!empty(Auth::guard('karyawan')->user()->foto))
                    ...
                    @endphp
                    <img src="{{ url($path) }}" alt="avatar" class="imaged w64" style="height">
                @else
                    <img src="{{ asset('template') }}/assets/img/sample/avatar/avatar1.jpg" alt="avatar"
                    ...
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem">
                            <span class="badge bg-danger"
                                style="position: absolute; top: 3px; right:10px; font-size: 0.6rem;z-index:999">{{ $rekappresensi->jmlhadir }}
                            </span>
                            <ion-icon name="person-outline" style="font-size: 1.6rem" class="text-primary mb-1"></ion-icon>
                                ...
                                <div class="historicontent">
                                    <div class="historidetail">
                                        <div class="iconpresensi">
                                            <ion-icon name="finger-print-outline" style="font-size: 32px;"
                                                class="text-success"></ion-icon>
                                        </div>
                                        <div class="datapresensi">
                                            <h3 style="line-height: 3px">{{ $d->nama_jam_kerja }} </h3>
                                            <h4>{{ date('d-m-Y', strtotime($d->tgl_presensi)) }} </h4>
                                            <span>
                                                {!! $d->jam_in != null ? date('H:i', strtotime($d->jam_in)) : '<span class="badge bg-warning">Belum Scan</span>' !!}
                                                {!! $d->jam_out != null
                                            ...
                                            <div id="keterangan" class="mt-2">
                                                ...
                                                @if ($jam_in > $jam_masuk)
                                                    ...
                                                    @endphp
                                                    <span class="badge bg-danger">Terlambat {{ $jmlterlambat }}</span>
                                                @else
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel">
                    ...
                    <ul class="listview image-listview">
                        @foreach ($leaderboard as $d)
                            <li>
                                <div class="item">
                                    <img src="{{ asset('template') }}/assets/img/sample/avatar/avatar1.jpg"
