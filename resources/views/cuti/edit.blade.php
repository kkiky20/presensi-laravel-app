    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $cuti->kode_cuti }} " readonly id="kode_cuti" class="form-control"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $cuti_nama_cuti }} " id="nama_cuti" class="form-control"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $cuti->jml_hari }} " id="jml_hari" class="form-control" name="jml_hari"
