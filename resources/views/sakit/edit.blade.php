...
@section('content')
    <div class="row" style="margin-top:70px">
        <div class="col">
            <form action="/izinsakit/{{ $dataizin->kode_izin }}/update" method="POST" id="frmIzin"
                enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <input type="text" value="{{ $dataizin->tgl_izin_dari }}" id="tgl_izin_dari" name="tgl_izin_dari" autocomplete="off"
                        class="form-control datepicker" placeholder="Dari">
                </div>
                <div class="form-group">
                    <input type="text" value="{{ $dataizin->tgl_izin_sampai }}" id="tgl_izin_sampai" name="tgl_izin_sampai" autocomplete="off"
                ...
                @if ($dataizin->doc_sid != null)
                    <div class="row">
                        <div class="col-12">
                            ...
                            @endphp
                            <img src="{{ url($docsid) }}" alt="" width="100px" height="150px">
                        </div>
                    </div>
                @endif
                ...
                <div class="form-group">
                    <input type="text" value="{{ $dataizin->keterangan }}" id="keterangan" name="keterangan" class="form-control" autocomplete="off"
