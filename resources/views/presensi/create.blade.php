...
@section('content')
    ...
    <audio id="notifikasi_in">
        <source src="{{ asset('template') }}/assets/sound/notifikasi_in.mp3" type="audio/mpeg">
    </audio>
    <audio id="notifikasi_out">
        <source src="{{ asset('template') }}/assets/sound/notifikasi_out.mp3" type="audio/mpeg">
    </audio>
    <audio id="radius_sound">
        <source src="{{ asset('template') }}/assets/sound/radius.mp3" type="audio/mpeg">
    </audio>
@endsection
