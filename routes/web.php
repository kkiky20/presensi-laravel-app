...
Route::middleware(['auth:user'])->group(function () {
    ...
    Route::post('/presensi/approvepengajuan', [PresensiController::class, 'approvepengajuan']);
    Route::get('/presensi/{id}/batalkanpengajuan', [PresensiController::class, 'batalkanpengajuan']);
    ...
    Route::post('/cuti/{kode_cuti}/delete', [CutiController::class, 'deletes']);
});
